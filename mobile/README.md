...
Depois de gerar o projeto nativo, abra a pasta `mobile/android` no Android Studio. Use JDK 17, aguarde o Gradle Sync e execute o módulo `app`. Se uma compilação anterior foi interrompida, feche instâncias extras do Gradle antes de tentar novamente.
