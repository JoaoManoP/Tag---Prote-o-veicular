      ...
      <Card>
        ...
        <Button
          ...
          onPress={async () => {
            ...
            }>('/api/account-security/password-reset/request', { email });
            setMessage(
              `${data.message}${data.developmentCode ? ` Código de desenvolvimento: ${data.developmentCode}` : ''}`
            );
      ...
      {!!challengeId && (
        <Card>
          ...
          <Button
            ...
            onPress={async () => {
              await api.post('/api/account-security/password-reset/confirm', {
                challengeId,
                code,
                newPassword
              });
