...
form.addEventListener('submit', async event => {
  ...
  if (isRegister && password !== document.getElementById('confirmPassword').value)
  ...
  try {
    ...
    if (isRegister)
      sessionStorage.setItem(
        'rastreon-subscription-confirmation',
        `${planNames[data.subscription?.plan] || planNames[selectedPlan]} ativado em modo demonstrativo.`
      );
