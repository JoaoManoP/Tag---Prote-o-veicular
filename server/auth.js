...
function validateRegistration(body) {
  ...
  if (password.length < 8 || password.length > 72 || !/[A-Za-z]/.test(password) || !/\d/.test(password)) errors.push('A senha deve ter de 8 a 72 caracteres, com letra e número.');
...
module.exports = { normalizeEmail, validateRegistration, requireAuth, hashPassword, verifyPassword };
