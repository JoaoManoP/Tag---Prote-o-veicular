...
const webRoot = path.join(root, 'frontend', 'web');
const backendRoot = path.join(root, 'backend', 'server');
const html = fs.readFileSync(path.join(webRoot, 'index.html'), 'utf8');
const ux = fs.readFileSync(path.join(webRoot, 'js', 'ux.js'), 'utf8');
const css = fs.readFileSync(path.join(webRoot, 'css', 'style.css'), 'utf8');
const refreshCss = fs.readFileSync(path.join(webRoot, 'css', 'dashboard-refresh.css'), 'utf8');
const navigationCss = fs.readFileSync(path.join(webRoot, 'css', 'navigation-redesign.css'), 'utf8');
const designSystem = fs.readFileSync(path.join(webRoot, 'css', 'design-system.css'), 'utf8');
const navigationRedesign = fs.readFileSync(
  path.join(webRoot, 'js', 'navigation-redesign.js'),
  'utf8'
);
const diagnostics = fs.readFileSync(path.join(backendRoot, 'vehicle-diagnostics.js'), 'utf8');
const dashboard = fs.readFileSync(path.join(webRoot, 'js', 'dashboard.js'), 'utf8');
const mapService = fs.readFileSync(path.join(webRoot, 'js', 'map-service.js'), 'utf8');
const navigationState = fs.readFileSync(path.join(webRoot, 'js', 'navigation-state.js'), 'utf8');
const home = fs.readFileSync(path.join(webRoot, 'home.html'), 'utf8');
const register = fs.readFileSync(path.join(webRoot, 'register.html'), 'utf8');
const authClient = fs.readFileSync(path.join(webRoot, 'js', 'auth.js'), 'utf8');
const convoyClient = fs.readFileSync(path.join(webRoot, 'js', 'convoy.js'), 'utf8');
...
test('mapa mantém ferramentas na lateral e celular possui QR com fallback manual', () => {
  const mobile = fs.readFileSync(path.join(webRoot, 'mobile.html'), 'utf8'),
    mobileScript = fs.readFileSync(path.join(webRoot, 'js', 'mobile.js'), 'utf8'),
    pair = fs.readFileSync(path.join(webRoot, 'pair.html'), 'utf8'),
    pairScript = fs.readFileSync(path.join(webRoot, 'js', 'pair.js'), 'utf8');
